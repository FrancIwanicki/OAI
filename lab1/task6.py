...
assert ivanytskyi_accuracy_score(df.actual_label.values, df.predicted_RF.values) == accuracy_score(df.actual_label.values, df.predicted_RF.values),'ivanytskyi_accuracy_score failed on RF'
assert ivanytskyi_accuracy_score(df.actual_label.values, df.predicted_LR.values) == accuracy_score(df.actual_label.values, df.predicted_LR.values),'ivanytskyi_accuracy_score failed on LR'
...
assert ivanytskyi_recall_score(df.actual_label.values, df.predicted_RF.values) == ivanytskyi_recall_score(df.actual_label.values, df.predicted_RF.values), 'ivanytskyi_recall_score failed on RF'
assert ivanytskyi_recall_score(df.actual_label.values, df.predicted_LR.values) == ivanytskyi_recall_score(df.actual_label.values, df.predicted_LR.values), 'ivanytskyi_recall_score failed on LR'
print('Recall RF: %.3f' % (ivanytskyi_recall_score(df.actual_label.values,df.predicted_RF.values)))
print('Recall LR: %.3f' % (ivanytskyi_recall_score(df.actual_label.values,df.predicted_LR.values)))
...
def ivanytskyi_f1_score(y_true, y_pred):
    ...
    return f1_score
assert ivanytskyi_f1_score(df.actual_label.values, df.predicted_LR.values) == f1_score(df.actual_label.values, df.predicted_LR.values), 'my_accuracy_scorefailed on LR'
